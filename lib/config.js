...
export const CONFIG = {
  ...
  // Sprint pulse: scope for the sprint the board's tickets belong to, including
  // the ones already Done (the main JQL deliberately excludes those).
  jiraSprintJql: "assignee = currentUser() AND project = PY AND sprint IN openSprints()",
